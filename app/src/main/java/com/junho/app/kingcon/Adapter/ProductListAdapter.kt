...
class ProductListAdapter(val context: Context, private val productData: ArrayList<ProductData>, private val callback: CallbackAdapter.Product) : RecyclerView.Adapter<ProductListAdapter.ViewHolder>() {
    ...
    class ViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        fun onBind(context: Context, productData: ProductData, position: Int, callback: CallbackAdapter.Product){
            //사진
            ...
            view.rvTagList.layoutManager = LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false)
