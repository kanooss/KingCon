...
class ProductInfoListAdapter(val context: Context, private val infoData: ArrayList<String>): androidx.recyclerview.widget.RecyclerView.Adapter<ProductInfoListAdapter.ProductInfoListViewHolder>() {
    ...
    class ProductInfoListViewHolder(val view: View): androidx.recyclerview.widget.RecyclerView.ViewHolder(view){
        fun onBind() {
