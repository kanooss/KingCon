...
import kotlinx.android.synthetic.main.adapter_select_tag_list.view.*

class AdapterSelectTag(val context: Context, private var tagList: TagData, private val callbackTag: CallbackAdapter.Tag?): RecyclerView.Adapter<AdapterSelectTag.ViewHolder>() {
    override fun getItemCount(): Int = tagList.title.size
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val inflater = context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
        val mainView = inflater.inflate(R.layout.adapter_select_tag_list, parent, false)
