...
class ViewTagFragment : Fragment(), CallbackAWSDB.Tag, CallbackAdapter.Tag {
    ...
    override fun callbackTagData(data: TagData) {
        ThreadUtils.runOnUiThread {
            ...
            rootView.rvTagList.layoutManager = LinearLayoutManager(rootView.context, LinearLayoutManager.VERTICAL, false)
        }
    }
    /** 태그 클릭 **/
