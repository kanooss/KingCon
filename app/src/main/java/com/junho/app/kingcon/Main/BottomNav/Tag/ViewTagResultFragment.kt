package com.junho.app.kingcon.Main.BottomNav.Tag
...
class ViewTagResultFragment : Fragment(), CallbackAdapter.Product {
    ...
    private fun setInitialize() {
        ...
        thread {
            ...
            ThreadUtils.runOnUiThread {
                rootView.rvProductList.layoutManager = LinearLayoutManager(rootView.context, LinearLayoutManager.VERTICAL, false)
                rootView.rvTagList.layoutManager = LinearLayoutManager(rootView.context, LinearLayoutManager.HORIZONTAL, false)
