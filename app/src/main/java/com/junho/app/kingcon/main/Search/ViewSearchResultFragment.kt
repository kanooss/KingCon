...
class ViewSearchResultFragment : androidx.fragment.app.Fragment(), CallbackAdapter.Product {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            searchText = it.getString(argSearchText, "")
        }
    }
    ...
    private fun setInitialize() {
        thread {
            ...
            ThreadUtils.runOnUiThread {
                rootView.rvSearchProductList.layoutManager = androidx.recyclerview.widget.LinearLayoutManager(
                    rootView.context,
